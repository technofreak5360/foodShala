      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fas fa-user"></i></span> Sign Up <span class="caret"></span> </a>
          ...
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <label class="btn btn-primary"><span class="fas fa-user" aria-hidden="true"></label>
            </span>
              </span>
            </div>           
          </div>
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <label class="btn btn-primary"><span class="fas fa-envelope" aria-hidden="true"></label>
            </span>
              </span>
            </div>           
          </div>
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <label class="btn btn-primary"><span class="fas fa-phone" aria-hidden="true"></span></label>
            </span>
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <label class="btn btn-primary"><span class="fas fa-home" aria-hidden="true"></label>
            </span>
              </span>
            </div>           
          </div>
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <label class="btn btn-primary"><span class="fas fa-unlock" aria-hidden="true"></span></label>
            </span>
